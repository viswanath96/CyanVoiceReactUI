...
function handleDownloadNowClick(param){
 ...
 function SingupCard({content,...props}) {
  ...
  return (
    ...
                  alignItems="stretch"
                >
                      <Button size="large" style={buttonstyle1} onClick={ () => props.signupButtonClick(content.downloadLink)} >
                          Sign Up
                      </Button>                  
                </Grid>
            </Box>
...
const mapActionToProps = {
    signupButtonClick : actions.SignupButtonClick
}
...
export default connect(mapStateToProps,mapActionToProps) (SingupCard)